...
function fenster_case_studies(): array
{
    ...
    $cache = [
        ...
        'heritage-aluminium-doors-wolverton' => [
            ...
            'summary' => 'Two timber French openings at the back of a Victorian terrace, replaced in jet black heritage aluminium, with the narrow one converted to a single wide leaf.',
            'lead' => 'This Victorian terrace in Wolverton had painted timber French doors on two openings at the back. Both are now Sheerline Classic heritage aluminium: the patio opening as a French pair again, and the narrow side path opening converted to a single wide leaf.',
            'products' => [
                ['label' => 'Heritage aluminium doors', 'url' => home_url('/heritage-aluminium-doors/')],
            ],
            ...
            'specs' => [
                ...
                ['label' => 'Configuration', 'value' => 'A French pair and a single wide leaf, both with toplights'],
            ...
            'installed' => [
                ...
                'Narrow French opening converted to one wide leaf',
