...
function fenster_case_studies(): array
{
    ...
    $cache = [
         ...
         * studies follow.
         *
         * EVERY ONE OF THESE CAME IN THROUGH THE REPAIR FORM. Owner, 2026-09-16:
         * "they all contacted through a form, you cant instant price repairs."
         * So no repair page offers the instant quote tool: every call to action
