...
function fenster_price_guide_pages(): array
{
    ...
    $guides = [
        'window-door-prices-milton-keynes' => [
            ...
            'examples' => [
                ['spec' => '1200 x 1200 uPVC casement window', 'details' => 'Liniar EnergyPlus, white smooth both sides, 150mm cill, Eco Toughened clear glass, trickle vent and white Signature handle', 'price' => '£600 inc VAT', 'image' => '/wp-content/themes/fenster/assets/images/price-guides/windowcad-casement-1200x1200.png', 'image_alt' => 'Screenshot from the pricing software we quote from, showing a 1200 x 1200 uPVC casement window', 'photo' => '/wp-content/themes/fenster/assets/images/case-studies/cs-leighton-buzzard-casement-street.jpg', 'photo_alt' => 'White uPVC casement windows we fitted in Leighton Buzzard', 'photo_caption' => 'Our install, Leighton Buzzard'],
                ['spec' => '900 x 2100 composite entrance door', 'details' => 'Distinction Esteem, anthracite grey outside, white inside, low aluminium threshold, 150mm composite door cill, clear glass and chrome lever handle', 'price' => '£2,000 inc VAT', 'image' => '/wp-content/themes/fenster/assets/images/price-guides/windowcad-composite-door-900x2100.png', 'image_alt' => 'Screenshot from the pricing software we quote from, showing a 900 x 2100 composite entrance door'],
                ['spec' => '3000 x 2100 aluminium bifold door', 'details' => 'Prestige aluminium 3-pane bifold, anthracite grey both sides, integral footer, 175mm cill, clear glass, black handles and trickle vent', 'price' => '£3,500 inc VAT', 'image' => '/wp-content/themes/fenster/assets/images/price-guides/windowcad-bifold-product-3000x2100.png', 'image_alt' => 'Product view from the pricing software we quote from, showing a 3000 x 2100 aluminium bifold door', 'photo' => '/wp-content/themes/fenster/assets/images/case-studies/cs-mk-whitehouse-bifold-open.jpg', 'photo_alt' => 'Anthracite grey aluminium bifold doors we fitted in Whitehouse, Milton Keynes', 'photo_caption' => 'Our install, Whitehouse'],
            ],
            'moves' => [
        ...
        'bifold-door-cost' => [
            ...
            'examples' => [
                ...
                ['spec' => '3000 x 2100 three-pane bifold', 'details' => 'Prestige aluminium bifold, open in, anthracite grey both sides, integral footer, 175mm cill, clear glass, black handles and trickle vent', 'price' => '£3,500 inc VAT', 'image' => '/wp-content/themes/fenster/assets/images/price-guides/windowcad-bifold-product-3000x2100.png', 'secondary_image' => '/wp-content/themes/fenster/assets/images/price-guides/windowcad-bifold-spec-3000x2100.png', 'image_alt' => 'Product view from the pricing software we quote from, showing a 3000 x 2100 aluminium bifold door', 'photo' => '/wp-content/themes/fenster/assets/images/case-studies/cs-mk-whitehouse-bifold-open.jpg', 'photo_alt' => 'Anthracite grey aluminium bifold doors we fitted in Whitehouse, Milton Keynes', 'photo_caption' => 'Our install, Whitehouse'],
        ...
        'double-glazing-cost' => [
            ...
            'examples' => [
                ['spec' => '1200 x 1200 single casement window', 'details' => 'Liniar EnergyPlus, white smooth both sides, 150mm cill, Eco Toughened clear glass, 5000EA trickle vent and white Signature handle', 'price' => '£600 inc VAT', 'image' => '/wp-content/themes/fenster/assets/images/price-guides/windowcad-casement-1200x1200.png', 'image_alt' => 'Screenshot from the pricing software we quote from, showing a 1200 x 1200 uPVC casement window', 'photo' => '/wp-content/themes/fenster/assets/images/case-studies/cs-leighton-buzzard-casement-street.jpg', 'photo_alt' => 'White uPVC casement windows we fitted in Leighton Buzzard', 'photo_caption' => 'Our install, Leighton Buzzard'],
    ...
    foreach ($guides as $slug => &$guide) {
        ...
        /* strtolower() also lowercases proper nouns, which turned the patio and
           French door label into "french" in the search snippet. Restore the
           capital on that word only, so every other label is untouched. */
        $label_lower = str_replace('french', 'French', strtolower($guide['label']));

        /* The description must not promise priced examples a guide does not
           have. template-parts/sections/price-guide.php only renders examples
           whose price starts with "£"; the rest are "To confirm from WindowCAD"
           placeholders and never appear. Test the same condition here so the
           wording follows the data. */
        $has_priced_example = false;
        foreach (($guide['examples'] ?? []) as $example) {
            if (str_starts_with((string) ($example['price'] ?? ''), '£')) {
                $has_priced_example = true;
                break;
            }
        }
        ...
        $guide['seo'] = [
            ...
            /* "WindowCAD" was the supplier's product name and meant nothing to a
               customer reading a search result, so it is out. The obvious
               replacement, "examples from our pricing software", pushes the
               longest guide to 169 characters and AI.md:268 caps generated meta
               descriptions at 160. This wording says the same thing, and with
               both variants the longest guide now lands at 154. */
            'meta_description' => $has_priced_example
                ? 'Clear fitted ' . $label_lower . ' guidance from Fenster Glazing, with examples we have priced, what affects the price and survey-confirmed next steps.'
                : 'Clear fitted ' . $label_lower . ' guidance from Fenster Glazing, with what moves the price and a quote tool that prices your exact job in minutes.',
...
function fenster_get_generated_page(?string $slug = null): ?array
{
    ...
    $launch_seo_overrides = [
        ...
        'hotel-and-hospitality-glazing' => [
            'title_tag' => 'Hotel & Hospitality Glazing | Windows and Doors',
            'meta_description' => 'Windows and doors for hotels, pubs and restaurants, phased by room, floor or wing so you lose the covers and bookings you chose to lose.',
        ],
        'care-home-glazing' => [
            'title_tag' => 'Care Home Window and Door Replacement',
            'meta_description' => 'Window and door replacement in care homes and supported living. One room opened at a time and closed the same day, with residents in place throughout.',
        ],
    ...
    /* WHY DISTINCTION. A support page for `/composite-doors/`, in the same shape
       as the windows hub's own reasoning: the composite page sells the door and
       this one answers why it is that door and not another. Kept off the menu
       and the product hubs deliberately — it is reached from the composite page
       and from the footer, the same way `/care-and-maintenance/` is. */
...
function fenster_maybe_render_generated_sitemap(): void
{
    ...
    /* Routes that are not generated pages but are still real, indexable URLs —
       the showrooms register themselves through this. Without a hook they exist,
       rank on their own merits, and are invisible to the sitemap. */
    foreach (apply_filters('fenster_extra_sitemap_urls', []) as $extra) {
        $loc = fenster_generated_url((string) ($extra['loc'] ?? ''));
        if (! $loc || isset($seen[$loc])) {
            continue;
        }
        $seen[$loc] = true;
