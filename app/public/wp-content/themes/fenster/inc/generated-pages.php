            ...
            'sections' => [
                ...
                [
                    ...
                    'body' => [
                        ...
                        'The chat is not an enquiry form and its conversation is not added to Fenster\'s customer or lead records by the website. If you have accepted optional cookies, Fenster stores the chat transcript, an anonymous website visitor and journey reference, and the page where each message was sent in its restricted Marketing Dashboard for quality assurance and to improve Legend. The transcript is retained for up to 30 days and is then deleted. If you reject optional cookies, the chat can still work but the transcript is not sent to that tracker.',
