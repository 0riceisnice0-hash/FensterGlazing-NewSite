...
function fenster_legend_verified_business_context(): string
{
    ...
    $facts = [
        ...
        'The consultation is low pressure and normally takes an hour at most. A window and door expert goes through the options, measures, and builds and prices the job on an iPad using the same software and price list as the online quote tool, so the figure matches. Fenster does not negotiate on price: the price is the price. Every decision maker does not need to be present. Colour swatches come to the visit; full product samples are at the Milton Keynes showroom only.',
