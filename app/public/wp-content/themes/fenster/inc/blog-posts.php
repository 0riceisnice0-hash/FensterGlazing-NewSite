...
function fenster_blog_posts(): array
{
    return [
        ...
        'draughty-windows-repair-or-replace' => [
            ...
            'meta_description' => 'Not every draughty window needs replacing. A straightforward checklist for what can be fixed, from seals to hinges and locks, and the signs the whole window is done.',
