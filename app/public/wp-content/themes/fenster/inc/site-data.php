            ...
            'double-glazing-replacement' => [
                ...
                'faqs' => [
                    ...
                    /* A PUBLISHED FIGURE, 2026-08-31, owner: "double glazed
                       ...
                       installed." Quoted here INCLUDING VAT at £204 because
                       that is the convention the rest of the site uses to
                       homeowners and the repairs page already states £96
                       including VAT; a mixed presentation would invite an
                       apples-to-oranges comparison between the two pages.
                       "Fitted" is load-bearing and stays: competitor figures
                       in this SERP are commonly supply-only.
                       The old answer said we "price each one rather than
                       publish a range", which now had to go or the page would
                       contradict itself. The figure is verifiable by the
                       reader on the same WindowCAD collection this route
                       already links to, so it is a starting price with
                       something behind it rather than a claim. */
                    ['question' => 'What does it cost?', 'answer' => 'Units start at £204 including VAT, fitted, and the price moves with the size of the unit, the glass in it and how many there are. Send rough sizes and a photograph and we can usually give you a price without coming out, or price it yourself on our online tool. There is no minimum.'],
