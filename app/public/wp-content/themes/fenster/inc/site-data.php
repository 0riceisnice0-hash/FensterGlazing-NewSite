    ...
    return [
        ...
        'product_content' => [
            ...
            'upvc-doors' => [
                ...
                'faqs' => [
                    ['question' => 'What configurations do uPVC doors come in?', 'answer' => 'A single door for a front, back or side entrance; French doors that open from the centre for a wider opening; or a stable door split across the middle, so the top half can open on its own. The style is drawn on top of whichever you pick: transoms and mullions divide the door, and each opening they make is filled with glass or with a panel.'],
