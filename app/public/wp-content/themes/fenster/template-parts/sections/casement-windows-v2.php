...
$faqs = [
    ...
    ['question' => 'What U-value can an EnergyPlus casement reach?', 'answer' => '0.95 W/m²K, with the 36mm triple glazed unit. That is the best figure we can offer, and it is an A+ window. Liniar publish a lower figure for the platform, but it needs a 40mm triple unit we do not supply, so it is not a number we will quote you. Size, layout, glass and reinforcement all move the complete-window figure anyway, so the final number follows the specification.'],
    ...
    ['question' => 'Can I have triple glazing?', 'answer' => 'Yes. The 70mm frame takes a 28mm double glazed unit or a 36mm triple, and those are the two we supply. Whether triple is worth it depends on the sash size, the weight and what you are actually trying to improve, so we will compare it with you rather than treating it as an automatic upgrade.'],
