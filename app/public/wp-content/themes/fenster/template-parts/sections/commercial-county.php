...
$hero = ['src' => $window_data['hero_image'], 'alt' => $window_data['hero_alt']];
$service_copy = [
...
<article class="fg-local fg-local--commercial">
    ...
    </div><figure class="fg-local__hero-media"><img <?php echo fenster_location_image_attrs($hero, ['loading' => 'eager', 'fetchpriority' => 'high']); ?>><figcaption><?php echo esc_html($hero['alt']); ?></figcaption></figure></div></section>
    ...
    <section class="fg-local__enquiry" id="commercial-county-enquiry"><div class="container fg-local__enquiry-grid"><div><p class="eyebrow">Talk to our commercial team</p><h2><?php echo esc_html('Tell us about your ' . $county . ' site.'); ?></h2><p>Attach drawings, photographs or schedules and tell us the scope you want priced. We will come back to you with the next steps.</p><a class="button" href="<?php echo esc_url($phone_url); ?>"><?php echo esc_html('Call ' . $phone); ?></a></div><div class="fg-local__form"><?php get_template_part('template-parts/components/enquiry-form', null, ['class' => 'fg-form', 'source' => 'Commercial glazing ' . $county, 'project_type' => 'Commercial glazing', 'show_company' => true, 'audience' => 'business', 'compact' => true, 'button_label' => 'Send project enquiry']); ?></div></div></section>
