    ...
    <section class="fg-aw-story fg-aw-story--roofline" data-fg-aw-story style="--fg-aw-panel-count: <?php echo esc_attr((string) (count($roofline_story_panels) + 1)); ?>;">
        <div class="fg-aw-story__stage">
            ...
            <div class="fg-rl-parts" aria-hidden="true">
                ...
                <span class="fg-rl-pin fg-rl-pin--fascia" style="--x: 72%; --y: 44%;"><i></i><b>Fascia</b></span>
                <span class="fg-rl-pin fg-rl-pin--soffit" style="--x: 42%; --y: 72%;"><i></i><b>Soffit</b></span>
                <span class="fg-rl-pin fg-rl-pin--gutter" style="--x: 80%; --y: 34%;"><i></i><b>Guttering</b></span>
            </div>
