        ...
        <section class="fg-fensa-hero">
            <div class="container fg-fensa-hero__grid">
                <div class="fg-fensa-hero__copy">
                    <p class="eyebrow"><?php esc_html_e('Glass and Glazing Federation guidance', 'fenster'); ?></p>
            ...
            <div class="container">
                <div class="fg-fensa-story">
                    ...
                    <div class="fg-fensa-story__copy">
                        <p class="eyebrow"><?php esc_html_e('What we check', 'fenster'); ?></p>
                ...
                <div class="fg-fensa-story fg-fensa-story--reverse">
                    ...
                    <div class="fg-fensa-story__copy">
                        <p class="eyebrow"><?php esc_html_e('Different protections, different jobs', 'fenster'); ?></p>
