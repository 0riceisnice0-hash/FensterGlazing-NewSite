...
- **Card heights are levelled by stretching the track**, not by trimming copy, so the collection descriptions can differ in length without the row going uneven.
