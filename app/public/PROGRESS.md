...
- **Measured against live, which still runs the old version.** At a true 390: 1576px to 1073px, a 32% cut. At 1440: 826px to 722px. The disc drops from 88px to 52px on a phone.
- **Aftercare was rewritten twice.** "More emphasis" was first read as more words, and at forty it became a wall beside three short cards, which the owner picked up immediately. Same four facts in twenty-eight. Card heights at 390 are now 138, 138, 117 and 158: aftercare is still the tallest, which suits the step that matters most, but it no longer dominates. **Emphasis on this rail is a matter of what the card says, not how long it runs.**
