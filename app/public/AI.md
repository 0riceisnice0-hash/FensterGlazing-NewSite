...
- **Live is at `79c464b` as of 2026-07-22.** This release put live Google reviews, the rebuilt review showcase and the richer LocalBusiness schema on production, and — with explicit owner approval after a `b0ec36a..79c464b` range check — also promoted composite doors V2, the Bolbeck Park and Wolverton case studies, the Aaron Isaacs team profile and the heritage door refinements. Live and `main` are now level. Verify the live theme rather than trusting this line.
