...
- Keep the explicit pre-chat acknowledgement in front of the composer. It must explain AI processing, possible inaccuracy, the non-binding nature of replies, sensitive-data caution and link to the Privacy Policy. The acknowledgement is held only in page memory and must never accept, overwrite or otherwise change the visitor's separate optional-cookie choice.
