...
- **The case-study strip is gated off** because no study claims the route and `fenster_case_studies_for_product()` falls back to ALL studies. The two heritage DOOR studies do not count: those jobs had no windows in them. Remove the gate when a heritage window study exists.
