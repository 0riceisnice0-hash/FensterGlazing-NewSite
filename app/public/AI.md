...
- **FENSA is an open question on this route.** The shared order-process rail promises "your FENSA certificate sent direct" in step 4. A FENSA certificate covers replacement windows and doors, and secondary glazing is an additional internal window rather than a replacement. Flagged to the owner 2026-08-07 and deliberately not changed, because the Order Process Rule is explicit that a route-specific `steps` argument needs him.
