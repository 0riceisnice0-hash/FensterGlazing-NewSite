...
- **Unresolved, worth asking Notan:** the sample card carries a `BY005` charcoal the brochure does not list, and lacks `BY012` White/Anthracite, which the brochure has. `BY005` is not in the data because there is no published name for it.
