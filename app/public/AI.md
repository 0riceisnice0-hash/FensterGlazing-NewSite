...
- Keep the explicit pre-chat acknowledgement in front of the composer. It must explain AI processing, possible inaccuracy, the non-binding nature of replies, sensitive-data caution, the 24-hour same-browser history and link to the Privacy Policy. After acknowledgement, `fenster_legend_chat_v1` may hold the acknowledgement and up to 16 recent messages for continuity across Fenster pages and tabs. Keep the TTL, Clear chat control and disclosure. This must never accept, overwrite or otherwise change the visitor's separate optional-cookie choice.
