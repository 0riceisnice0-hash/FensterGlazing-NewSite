...
- **Live is at `f4ad6fb` as of 2026-07-22.** Live Google reviews, authenticated email through Brevo, town case-study proof, the MK title/meta fixes and the guide routing are all on production, along with the concurrent session's composite-doors work. Live and `main` are level. Verify the live theme rather than trusting this line.
