...
- **ONE INSTALL OF OURS EXISTS AND IT IS SHOWN TWICE FROM ONE FRAME**: the whole ironstone gable, and a closer crop of the same photograph. Owner instruction, 2026-08-11: do not draw attention to it being the only one. So the copy describes the house and the work and makes no claim about how many we have fitted. **Do not write "our only install" on this page, and do not imply a portfolio either.**
