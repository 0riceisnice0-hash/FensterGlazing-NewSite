...
- **Live is at `b0ec36a` (branch `release/heritage-doors`) as of 2026-07-21: the previous live state `658ba34` plus the dedicated `/heritage-aluminium-doors/` page, and nothing else.** Live and `main` have deliberately diverged; `main` also holds unapproved composite-door and case-study work. See `LIVECHANGES.md` before any deploy. New agents should verify the live theme rather than trusting this line.
