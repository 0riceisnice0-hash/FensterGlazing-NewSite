...
- **Live and test are at runtime commit `c87391f`, deployed 2026-07-30 from `codex/ads-production-release`.** The release was isolated directly on the checksummed live runtime `572fe3c`; its only theme diff is the completed-quote advertising attribution path. Backup before it: `~/backups/fenster-theme/fenster-pre-c87391f-20260730-120759.tar.gz` (375M, 1,738 entries). Six changed runtime files match the committed tree byte for byte. Eight production routes returned `200`, the head-term marker remained present, and a cache-busted browser test produced `tracking=FG2-AAEEB743178E4E16B3&ads=12345678901`; WordPress held the matching test `gclid` and ad-group tracker.
...
- The previous live runtime was `572fe3c` (2026-07-29). Before that, `6ea0dba`, `834b424`, `4458fc6` (2026-07-24) and `94e7d0f`.
