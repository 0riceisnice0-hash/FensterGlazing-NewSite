...
- Latest known deployed live commit after this update: `4ce91a6` (`Clean up site copy audit findings`). Check `git log --oneline -8` and confirm against the live theme before assuming this line is still current.
