...
- **Live and test are at runtime commit `289b2c2`, deployed 2026-07-31 from `codex/tracking-repair`.** The theme matches the committed tree byte for byte. Backup before it: `~/backups/fenster-theme/fenster-pre-289b2c2-20260731-102149.tar.gz` (375M). Protected-test QA covered accept-all, necessary-only and marketing-only attribution; the final tree deliberately leaves Legend overlay code unchanged.
