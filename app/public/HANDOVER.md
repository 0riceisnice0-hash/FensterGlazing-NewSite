...
- **The unit is built from the owner's photograph of the showroom sample**, supplied 2026-08-04 and the reference for the scale and shape of both the frame and the controls. Check it before changing either.
  ...
  - There is **no wide colour matched border**. An earlier pass drew a 24mm profile right round the inside of the glass and it was wrong. On the real unit the glass runs almost to the bead; the only things in front of the blind are the warm edge spacer, the blind's head, the rail and the two magnets.
