...
**LIVE IS `0b4a1385`**, tag `live-casestudy-2026-09-03`, verified by
checksum rather than copied from a document. **It is NOT an ancestor of `main`.**

| | SHA | theme tree |
| --- | --- | --- |
| live | `0b4a1385` (tag `live-casestudy-2026-09-03`) | `0d609162` |
| test | `770f5607` | `c58416fc` |
| `main` | `770f5607` (docs commit above it) | `c58416fc` |
...
- **NEVER cut a release from a superseded tag.** There are five, and only the
  ...
  live-casestudy-2026-09-03        0b4a1385   LIVE
  ```

- **Either build on `0b4a1385`, or ship a range from `main`** once the rest of
