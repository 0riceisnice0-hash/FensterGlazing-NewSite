...
- **Live is `3ec2d76`, deployed 2026-08-02, and live, `main` and test are level.** Established by checksum as `6fdf9ff`/`036c02e` (theme-identical) before deploying, on four theme files. Backup: `~/backups/fenster-theme/fenster-pre-3ec2d76-20260802-141450.tar.gz` (378M, 1,771 entries). **Still re-establish by checksum before the next release rather than trusting this line, and on more than one file.**
