...
- **Live is at `4458fc6` as of 2026-07-24, and live, `main` and test are all level.** Two releases shipped that day: `94e7d0f` gave six window/door routes their own product photography instead of two shared pools, and `4458fc6` added the pre-selected enquiry-type gate, the heritage configuration cut from nine to six, the colour hub hero photograph, the homepage card edge fix and the roof lantern configuration wall. Backups: `fenster-pre-94e7d0f-20260724-085656.tar.gz` and `fenster-pre-4458fc6-20260724-102814.tar.gz`.
