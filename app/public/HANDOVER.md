...
- **Live is `64f4e51`, deployed 2026-08-02, and live, `main` and test are level.** That commit is the `codex/tracking-repair` merge plus six fixes to it. Backup before it: `~/backups/fenster-theme/fenster-pre-64f4e51-20260802-093342.tar.gz` (375M, 1,739 entries). Live was established by checksum as `289b2c2` before deploying, and the range was 74 commits, put to the owner and approved. **Still re-establish by checksum before the next release rather than trusting this line.**
