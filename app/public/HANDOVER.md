...
- **Live is at `94e7d0f` as of 2026-07-24, and live, `main` and test are all level.** The last release gave `/casement-windows/`, `/flush-casement-windows/`, `/french-casement-windows/`, `/tilt-turn-windows/`, `/bow-bay-windows/` and `/aluminium-sliding-doors/` their own product photography instead of two shared pools. Backup: `fenster-pre-94e7d0f-20260724-085656.tar.gz`. Before that, live was `fa6596b` (2026-07-23, email signature assets), not the `f4ad6fb` these docs had claimed since 2026-07-22.
