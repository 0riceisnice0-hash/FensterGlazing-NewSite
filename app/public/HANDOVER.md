...
- **Live is at `834b424` as of 2026-07-29.** Live, `main` and test are all level. The release was 54 commits: a day of product, imagery, copy and navigation work, plus the other session's Google Ads conversion tracking. Verify by checksum rather than trusting this line.
